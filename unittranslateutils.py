...
class TestTranslate(unittest.TestCase):
    ...
    def testconcat(self):
        ...
        self.assertEqual('artikel1<br>artikel2<br>artikel3', transform.concat('artikel1', 'artikel2', 'artikel3', sep='<br>'), 'test concatenate')
    ...
    def testunique(self):
        ...
        newdomain = 'test' + transform.unique('test')
        self.assertEqual(True, botslib.checkunique(newdomain, 1), 'init new domain')
        self.assertEqual(False, botslib.checkunique(newdomain, 1), 'seq should be 2')
        self.assertEqual(False, botslib.checkunique(newdomain, 3), 'seq should be 2')
        self.assertEqual(True, botslib.checkunique(newdomain, 2), 'next one')
        self.assertEqual(True, botslib.checkunique(newdomain, 3), 'next one')
        self.assertEqual(True, botslib.checkunique(newdomain, 4), 'next one')
        self.assertEqual(False, botslib.checkunique(newdomain, 4), 'next one')
        self.assertEqual(False, botslib.checkunique(newdomain, 6), 'next one')
        self.assertEqual(True, botslib.checkunique(newdomain, 5), 'next one')
