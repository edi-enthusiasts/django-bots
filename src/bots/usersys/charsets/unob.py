...
class Codec(codecs.Codec):
    ...
    def encode(self, input_data, errors='strict'):
        return codecs.charmap_encode(input_data, errors, encoding_map)

    def decode(self, input_data, errors='strict'):
        return codecs.charmap_decode(input_data, errors, decoding_map)
...
class IncrementalEncoder(codecs.IncrementalEncoder):
    ...
    def encode(self, input_data, final=False):
        return codecs.charmap_encode(input_data, self.errors, encoding_map)[0]


class IncrementalDecoder(codecs.IncrementalDecoder):

    def decode(self, input_data, final=False):
        return codecs.charmap_decode(input_data, self.errors, decoding_map)[0]
