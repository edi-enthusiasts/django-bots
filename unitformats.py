...
class TestFormatFieldVariableOutmessage(unittest.TestCase):
    ...
    def test_out_var_R(self):
        ...
        self.edi.ta_info['decimaal'] = '.'
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1234', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-1.234', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1<3', tfield1, testdummy, nodedummy)  # wrong char
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1-3', tfield1, testdummy, nodedummy)  # '-' in middel of number
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '123-', tfield1, testdummy, nodedummy)  # '-' at end of number
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1,3', tfield1, testdummy, nodedummy)  # ',', where ',' is not traid sep.
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1+3', tfield1, testdummy, nodedummy)  # '+' in middle of number
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1E3', tfield1, testdummy, nodedummy)  # exponent
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '13+', tfield1, testdummy, nodedummy)  # '+' at end
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '0.100', tfield1, testdummy, nodedummy)  # field too big
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '.', tfield1, testdummy, nodedummy)  # no num
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-', tfield1, testdummy, nodedummy)  # no num
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '.001', tfield1, testdummy, nodedummy)  # bots adds 0 before dec, thus too big
        ...
        # test exp
        self.assertEqual(self.edi._formatfield('12E+3', tfield2, testdummy, nodedummy), '1.2E+4', 'Exponent notation is possible')
        self.assertEqual(self.edi._formatfield('12E3', tfield2, testdummy, nodedummy), '1.2E+4', 'Exponent notation is possible->to std notation')
        self.assertEqual(self.edi._formatfield('12e+3', tfield2, testdummy, nodedummy), '1.2E+4', 'Exponent notation is possible; e->E')
        self.assertEqual(self.edi._formatfield('12e3', tfield2, testdummy, nodedummy), '1.2E+4', 'Exponent notation is possible; e->E')
        # self.assertEqual(self.edi._formatfield('12345E+3', tfield2, testdummy, nodedummy), '12345000', 'do not count + and E')
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '12345678E+3', tfield2, testdummy, nodedummy)  # too big with exp
        tfield3 = ['TEST1', 'M', 8,   'R', True,   3,      5, 'R']
        # no negative exponents for R
        # print '\n>>>',self.edi._formatfield('12E-3', tfield3, testdummy, nodedummy)
        self.assertEqual(self.edi._formatfield('12E-3', tfield3, testdummy, nodedummy), '0.012', 'Exponent notation is possible')
        self.assertEqual(self.edi._formatfield('12e-3', tfield2, testdummy, nodedummy), '0.012', 'Exponent notation is possible; e->E')
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '12345678E-8', tfield2, testdummy, nodedummy)  # gets 0.12345678, is too big
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '12345678E+3', tfield2, testdummy, nodedummy)  # too big with exp
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-12345678', tfield2, testdummy, nodedummy)  # field too large

    def test_out_var_N(self):
        self.edi.ta_info['decimaal'] = '.'
        self.edi.ta_info['lengthnumericbare'] = True
        ...
        self.edi.ta_info['decimaal'] = '.'
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1234', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-1234.56', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1<3', tfield1, testdummy, nodedummy)  # wrong char
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1-3', tfield1, testdummy, nodedummy)  # '-' in middel of number
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '123-', tfield1, testdummy, nodedummy)  # '-' at end of number
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1,3', tfield1, testdummy, nodedummy)  # ',', where ',' is not traid sep.
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1+3', tfield1, testdummy, nodedummy)  # '+' in middle of number (no exp)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1E3', tfield1, testdummy, nodedummy)  # '+' in middle of number (no exp)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '13+', tfield1, testdummy, nodedummy)  # '+' at end
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1234.100', tfield1, testdummy, nodedummy)  # field too big
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '.', tfield1, testdummy, nodedummy)  # no num
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-', tfield1, testdummy, nodedummy)  # no num
        # test filling up to min length
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '178E+4', tfield2, testdummy, nodedummy)  # too big with exp
    ...
    def test_out_var_D(self):
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '2007093112', tfield1, testdummy, nodedummy)  # too long
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '20070931', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-0070931', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '70931', tfield1, testdummy, nodedummy)  # too short
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '0931', tfield1, testdummy, nodedummy)  # too short
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '0931BC', tfield1, testdummy, nodedummy)  # alfanum
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, 'OOOOBC', tfield1, testdummy, nodedummy)  # alfanum

    def test_out_var_T(self):
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '12345678', tfield1, testdummy, nodedummy)  # no valid time
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '240001', tfield1, testdummy, nodedummy)  # no valid time
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '126101', tfield1, testdummy, nodedummy)  # no valid time
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '120062', tfield1, testdummy, nodedummy)  # no valid time - python allows 61 secnds?
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '240000', tfield1, testdummy, nodedummy)  # no valid time
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '250001', tfield1, testdummy, nodedummy)  # no valid time
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-12000', tfield1, testdummy, nodedummy)  # no valid time
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '120', tfield1, testdummy, nodedummy)  # no valid time
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '0931233', tfield1, testdummy, nodedummy)  # too short
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '11PM', tfield1, testdummy, nodedummy)  # alfanum
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, 'TIME', tfield1, testdummy, nodedummy)  # alfanum
        tfield2 = ['TEST1', 'M', 4,   'T', True, 0,        4, 'T']
        #                    length       decimals minlength
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '230001', tfield2, testdummy, nodedummy)  # time too long
        tfield3 = ['TEST1', 'M', 6,   'T', True, 0,        6, 'T']
        #                   length        decimals minlength
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '2300', tfield3, testdummy, nodedummy)  # time too short

    def test_out_var_A(self):
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, 'abcdef', tfield1, testdummy, nodedummy)
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, 'a', tfield1, testdummy, nodedummy)  # field too small
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, ' ', tfield1, testdummy, nodedummy)  # field too small
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '', tfield1, testdummy, nodedummy)  # field too small
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, 'abcdef', tfield1, testdummy, nodedummy)
...
class TestFormatFieldFixedOutmessage(unittest.TestCase):
    ...
    def test_out_fixedR(self):
        ...
        self.edi.ta_info['decimaal'] = '.'
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '.12', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-.12', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1234', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-1.234', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1<3', tfield1, testdummy, nodedummy)  # wrong char
        ...
        # test exp
        self.assertEqual(self.edi._formatfield('12E+3', tfield2, testdummy, nodedummy),   '001.2E+4', 'Exponent notation is possible')
        self.assertEqual(self.edi._formatfield('12E3', tfield2, testdummy, nodedummy),    '001.2E+4', 'Exponent notation is possible->to std notation')
        self.assertEqual(self.edi._formatfield('12e+3', tfield2, testdummy, nodedummy),   '001.2E+4', 'Exponent notation is possible; e->E')
        self.assertEqual(self.edi._formatfield('12e3', tfield2, testdummy, nodedummy),    '001.2E+4', 'Exponent notation is possible; e->E')
        self.assertEqual(self.edi._formatfield('4567E+3', tfield2, testdummy, nodedummy), '4.567E+6', 'do not count + and E')
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '12345678E+3', tfield2, testdummy, nodedummy)  # too big with exp
        # no negative exponents for R
    ...
    def test_out_fixedRL(self):
        ...
        # no negative exponents for R
        # #print '>>',self.edi._formatfield('12E-3', tfield2, testdummy, nodedummy)
        self.assertEqual(self.edi._formatfield('12E-3', tfield2, testdummy, nodedummy),       '0.012   ', 'Exponent notation is possible')
        self.assertEqual(self.edi._formatfield('12e-3', tfield2, testdummy, nodedummy),       '0.012   ', 'Exponent notation is possible; e->E')
        self.assertEqual(self.edi._formatfield('1234567E-3', tfield2, testdummy, nodedummy),  '1234.567', 'do not count + and E')
        self.assertEqual(self.edi._formatfield('1234567E-6', tfield2, testdummy, nodedummy),  '1.234567', 'do not count + and E')
        self.assertEqual(self.edi._formatfield('123456E-6', tfield2, testdummy, nodedummy),   '0.123456', 'do not count + and E')
    ...
    def test_out_fixedN(self):
        ...
        self.edi.ta_info['decimaal'] = '.'
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '123.1049', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '123', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1234', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-1234.56', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1<3', tfield1, testdummy, nodedummy)  # wrong char
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1-3', tfield1, testdummy, nodedummy)  # '-' in middel of number
    ...
    def test_out_fixedT(self):
        tfield1 = ['TEST1', 'M', 4, 'T', True, 0,        4, 'T']
        #                   length      decimals minlength
        self.assertEqual(self.edi._formatfield('2359', tfield1, testdummy, nodedummy), '2359', 'basic')
        self.assertEqual(self.edi._formatfield('0000', tfield1, testdummy, nodedummy), '0000', 'basic')
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '2401', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1261', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1262', tfield1, testdummy, nodedummy)  # python allows 61 seconds?
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '2400', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '2501', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-1200', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '120', tfield1, testdummy, nodedummy)  # too short
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '093123', tfield1, testdummy, nodedummy)  # too long
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '11PM', tfield1, testdummy, nodedummy)  # alfanum
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, 'TIME', tfield1, testdummy, nodedummy)  # alfanum
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '240001', tfield2, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '126101', tfield2, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '120062', tfield2, testdummy, nodedummy)  # python allows 61 secnds?
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '240000', tfield2, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '250001', tfield2, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-12000', tfield2, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '120', tfield2, testdummy, nodedummy)  # too short
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '0931233', tfield2, testdummy, nodedummy)  # too short
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1100PM', tfield2, testdummy, nodedummy)  # alfanum
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '11TIME', tfield2, testdummy, nodedummy)  # alfanum

    def test_out_fixedA(self):
...
class TestFormatFieldInmessage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.edi = inmessage.parse_edi_file(
            frompartner='',
            topartner='',
    ...
    def test_in_R(self):
        ...
        self.assertEqual(self.edi._formatfield('1', tfield1, testdummy, nodedummy), '1', 'basic')
        self.assertEqual(self.edi._formatfield('0', tfield1, testdummy, nodedummy), '0', 'zero stays zero')
        self.assertEqual(self.edi._formatfield('-0', tfield1, testdummy, nodedummy), '-0', 'keep neg.zero')
        self.assertEqual(self.edi._formatfield('-0.00', tfield1, testdummy, nodedummy), '-0.00', 'keep neg.zero, keep decimals')
        self.assertEqual(self.edi._formatfield('-.12', tfield1, testdummy, nodedummy), '-0.12', 'no zero before dec,sign is OK')
        self.assertEqual(self.edi._formatfield('123', tfield1, testdummy, nodedummy), '123', 'numeric field at max')
        self.assertEqual(self.edi._formatfield('001', tfield1, testdummy, nodedummy), '1', 'leading zeroes are removed')
        self.assertEqual(self.edi._formatfield('0.10', tfield1, testdummy, nodedummy), '0.10', 'keep decimal zeroes')
        self.assertEqual(self.edi._formatfield('-1.23', tfield1, testdummy, nodedummy), '-1.23', 'numeric field at max with minus and decimal sign')
        self.edi.ta_info['decimaal'] = ','
        self.assertEqual(self.edi._formatfield('1,23', tfield1, testdummy, nodedummy), '1.23', 'other dec.sig, replace')
        self.edi.ta_info['decimaal'] = '.'
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1234', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '0001', tfield1, testdummy, nodedummy)  # leading zeroes; field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-1.234', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1<3', tfield1, testdummy, nodedummy)  # wrong char
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1-3', tfield1, testdummy, nodedummy)  # '-' in middel of number
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1,3', tfield1, testdummy, nodedummy)  # ',', where ',' is not traid sep.
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1+3', tfield1, testdummy, nodedummy)  # '+' in middle of number
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '13+', tfield1, testdummy, nodedummy)  # '+' at end of number
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '0.100', tfield1, testdummy, nodedummy)  # field too big
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1E3', tfield1, testdummy, nodedummy)  # exponent
        # test field to short
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1235', tfield2, testdummy, nodedummy)  # field too short
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-12.34', tfield2, testdummy, nodedummy)  # field too short
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-', tfield2, testdummy, nodedummy)  # field too short
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '.', tfield2, testdummy, nodedummy)  # field too short
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-.', tfield2, testdummy, nodedummy)  # field too short
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '12E+3', tfield2, testdummy, nodedummy)  # field too large
        tfield4 = ['TEST1', 'M', 8, 'N', True, 3, 0, 'R']
        self.assertEqual(self.edi._formatfield('123.4561', tfield4, testdummy, nodedummy), '123.4561', 'no check for to many digits incoming')  # should round here?
    ...
    def test_in_N(self):
        ...
        #                   length      decimals minlength
        # self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '', tfield1, testdummy, nodedummy)  # empty string
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1', tfield1, testdummy, nodedummy)  # empty string
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '0', tfield1, testdummy, nodedummy)  # empty string
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-0', tfield1, testdummy, nodedummy)  # empty string
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '01.00', tfield1, testdummy, nodedummy)  # empty string
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1,3', tfield1, testdummy, nodedummy)  # ',', where ',' is not traid sep.
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1+3', tfield1, testdummy, nodedummy)  # '+' in middle of number
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '13+', tfield1, testdummy, nodedummy)  # '+' in middle of number
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '0.100', tfield1, testdummy, nodedummy)  # field too big
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1E3', tfield1, testdummy, nodedummy)  # no exp
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '.', tfield1, testdummy, nodedummy)  # no exp
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-', tfield1, testdummy, nodedummy)  # no exp
        # test field to short
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '123.4561', tfield4, testdummy, nodedummy)  # to many digits
    ...
    def test_in_I(self):
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '123456', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '000100', tfield1, testdummy, nodedummy)  # field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '000001', tfield1, testdummy, nodedummy)  # leading zeroes; field too large
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '12<3', tfield1, testdummy, nodedummy)  # wrong char
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '12-3', tfield1, testdummy, nodedummy)  # '-' in middel of number
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '12,3', tfield1, testdummy, nodedummy)  # ','.
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '12+3', tfield1, testdummy, nodedummy)  # '+' in middle of number
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '123+', tfield1, testdummy, nodedummy)  # '+'
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '12E+3', tfield1, testdummy, nodedummy)  # '+'
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-', tfield1, testdummy, nodedummy)  # only -
        # test field to short
        tfield2 = ['TEST1', 'M', 8, 'I', True, 2, 5, 'I']
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '1235', tfield2, testdummy, nodedummy)  # field too short
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-1234', tfield2, testdummy, nodedummy)  # field too short
        tfield3 = ['TEST1', 'M', 18, 'I', True, 0, 0, 'I']
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '12E+3', tfield3, testdummy, nodedummy)  # no exponent
        # WARN: dubious tests. This is Bots filosophy: be flexible in input, be right in output.
    ...
    def test_in_T(self):
        ...
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '240001', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '126101', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '120062', tfield1, testdummy, nodedummy)  # python allows 61 seconds?
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '240000', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '250001', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '-12000', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '120', tfield1, testdummy, nodedummy)  # too short
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '11PM', tfield1, testdummy, nodedummy)  # alfanum
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, 'TIME', tfield1, testdummy, nodedummy)  # alfanum
    ...
    def test_in_A(self):
        ...
        self.assertEqual(self.edi._formatfield('a	b', tfield1, testdummy, nodedummy), 'a	b', 'basic')
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, 'abcdef', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, 'ab    ', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '    ab', tfield1, testdummy, nodedummy)
        ...
        # self.assertEqual(self.edi._formatfield('  ', tfield1, testdummy, nodedummy), '', 'basic')
        self.assertEqual(self.edi._formatfield('a	b', tfield1, testdummy, nodedummy), 'a	b', 'basic')
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, 'a', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, 'abcdef', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, 'ab    ', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '    ab', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, ' ', tfield1, testdummy, nodedummy)
        self.assertRaises(bots.botslib.MessageError, self.edi._formatfield, '', tfield1, testdummy, nodedummy)
