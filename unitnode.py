...
class Testnode(unittest.TestCase):
    ...
    def testedifact01(self):
        ...
        for t in out.getloop({'BOTSID': 'UNB'}):
            if first:
                self.assertEqual('15', t.getcountsum(
                        {'BOTSID': 'UNB'},
                        {'BOTSID': 'UNH'},
                ...
                self.assertEqual('8', t.getcountsum(
                        {'BOTSID': 'UNB'},
                        {'BOTSID': 'UNH'},
                        {'BOTSID': 'LIN'},
                ...
                self.assertEqual('0', t.getcountsum(
                        {'BOTSID': 'UNB'},
                        {'BOTSID': 'UNH'},
                        {'BOTSID': 'LIN'},
                ...
                self.assertEqual('54.4', t.getcountsum(
                        {'BOTSID': 'UNB'},
                        {'BOTSID': 'UNH'},
                        {'BOTSID': 'LIN'},
                ...
                self.assertEqual('1', t.getcountsum(
                        {'BOTSID': 'UNB'},
                        {'BOTSID': 'UNH'},
                        {'BOTSID': 'LIN'},
                        {'BOTSID': 'QTY', 'C186.6063': '47', 'C186.6060': None}
